 ...
 */
class getTipoProductoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipoProductoRepository' shared autowired service.
     *
     * @return \App\Repository\TipoProductoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipoProductoRepository.php';

        return $container->privates['App\\Repository\\TipoProductoRepository'] = new \App\Repository\TipoProductoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
